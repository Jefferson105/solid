    ...
    <footer className="footer container">
        <div className="footer__content">
            <div>
                ...
                <p className="footer__txt footer__txt--top">
                    Telefone: (11) 941578881
                </p>
                <p className="footer__txt footer__txt--top">
                    Telefone: (11) 41038163
                </p>
                <p className="footer__socials">
                    ...
                    <a
                        ...
                        className="footer__social"
                    >
                        <img src="/static/img/linkedin-logo.svg" />
                    </a>
                </p>
            </div>
            <div className="footer__list-content">
                <ul className="footer__list">
                    <li className="footer__item">
                        <Link href="/servicos">
                            <a className="link">Nossos Serviços</a>
                        </Link>
                    </li>
                    <li className="footer__item">
                        <Link href="/sobre">
                            <a className="link">Sobre a Solid</a>
                        </Link>
                    </li>
                    <li className="footer__item">
                        <Link href="/clientes">
                            <a className="link">Clientes</a>
                        </Link>
                    </li>
                    <li className="footer__item">
                        <Link href="/contato">
            ...
            <div>
                <div className="footer__box">
                    ...
                    >
                        ...
                        />
                        <button className="header__button footer__button">
                            Cadastrar
                        </button>
                    </form>
                </div>
